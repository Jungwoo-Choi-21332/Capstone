...
import memtorch
import numpy as np
from network import WaferMLP

# 1. 경로 자동 설정
current_dir = os.path.dirname(os.path.abspath(__file__))
data_path = os.path.join(current_dir, "processed_mixed_wafer_data.pth")
model_weights_path = os.path.join(current_dir, "MLP_v1.pth")
...
# 결과 그래프 저장
result_img_path = os.path.join(current_dir, "final_evaluation_result_MLP_v1.png")
